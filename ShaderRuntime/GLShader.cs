...
namespace ShaderRuntime
{
    ...
    public interface GLShader : IDisposable
    {
		...
		/// <summary>
		/// Gets all the names of the uniform parameters.
		/// </summary>
		/// <returns>A collection containing all the uniform names.</returns>
		IEnumerable<string> GetUniformNames();
		/// <summary>
		/// Returns the location of <paramref name="name"/>.
		/// </summary>
		/// <param name="name">The name of the parameter.</param>
		/// <returns>An int representing the value in the GLSL shader.</returns>
		/// <exception cref="InvalidIdentifierException">Should be thrown if <paramref name="name"/> is not an identifier in the shader.</exception>
        ...
        void Compile();
		/// <summary>
		/// Recompiles the shader. This will change the shader if it is loaded from disk.
		/// </summary>
		void Recompile();
